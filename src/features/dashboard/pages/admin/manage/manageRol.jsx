          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p
                ...
                style={{ color: "var(--card-muted)" }}>
                Recomendación: mantén nombres claros (Administrador, Docente,
                Estudiante).
              </p>
            </div>
          </div>
                ...
                <div
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p
                        className="text-sm font-bold capitalize truncate mt-3"
                        style={{ color: "var(--card-text)" }}>
                        {role.name}
                      </p>
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p
                  className="text-xs mt-1"
                  style={{ color: "var(--card-muted)" }}>
                  Nombra el rol de forma clara (ej: Administrador, Docente,
                  Estudiante).
                </p>
              </div>
