    ...
    <div
      ...
      <div
        ...
        {isFirst ? (
          ...
          <Trophy className="h-6 w-6 fill-white text-white" />
        )}
      </div>

      <div className="relative">
        <div
          className={`absolute inset-0 animate-spin-slow rounded-full bg-gradient-to-br ${rankColors[rank]} opacity-30 blur-md`}
        />
        <div
          className={`relative ${size} rounded-full border-4 bg-gradient-to-br ${rankColors[rank]} p-1 shadow-xl`}>
      ...
      <div className="text-center">
        <p
          className={`font-bold ${isFirst ? "text-xl" : "text-base"} text-foreground`}>
          {participant.full_name}
        </p>
        <div className="mt-1 flex items-center justify-center gap-1">
          <span
            className={`font-bold ${isFirst ? "text-2xl" : "text-xl"} text-accent`}>
