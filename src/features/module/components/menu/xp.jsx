...
export default function XpPanel({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[20px] px-2 py-0 ${className}`}
      style={{
        minWidth: 100,
      ...
      <div className="relative flex items-center gap-3">
        <div
          ...
          <span className="grid h-9 w-9 place-items-center rounded-full bg-accent/15 ring-1 font-bold  ring-accent/25">
