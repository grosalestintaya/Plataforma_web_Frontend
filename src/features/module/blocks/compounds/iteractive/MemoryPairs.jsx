...
export default function MemoryPairs({
  ...
  return (
    <section className="mx-auto flex h-full min-h-0 w-full max-w-[1120px] flex-col gap-4 overflow-hidden rounded-[2rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.10),rgba(107,15,0,0.14))] p-3 shadow-[0_22px_60px_rgba(102,24,5,0.18)] backdrop-blur-[2px] sm:gap-5 sm:p-4">
      {instruction ? (
      ...
      <div className="grid min-h-0 flex-1 gap-4 overflow-hidden lg:grid-cols-[minmax(15rem,18rem)_minmax(0,1fr)]">
        <aside className="flex min-h-0 w-full shrink-0 flex-col gap-3 rounded-[1.8rem] bg-[linear-gradient(180deg,rgba(159,29,9,0.18),rgba(95,13,4,0.24))] p-4 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_18px_40px_rgba(99,21,5,0.14)]">
          <div className="grid min-h-[9rem] place-items-center rounded-[1.6rem] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.12),rgba(255,255,255,0.02)_62%)] px-4 py-6 text-center sm:min-h-[11rem]">
            <div className="max-w-[16rem] text-2xl font-black leading-tight sm:text-3xl lg:text-4xl">
              {titleText}
            </div>
          </div>

          {sectionTitleText ? (
            <div className="rounded-full bg-[linear-gradient(90deg,rgba(255,255,255,0.12),rgba(255,255,255,0.04))] px-4 py-3 text-center text-xs font-black uppercase tracking-[0.28em] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.14)] sm:text-sm">
              {sectionTitleText}
            </div>
          ) : null}

          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
            <div className="rounded-[1.5rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.14),rgba(255,255,255,0.05))] px-4 py-4 text-center text-lg font-black shadow-[inset_0_1px_0_rgba(255,255,255,0.16)] sm:text-xl lg:text-2xl">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 overflow-hidden rounded-[1.8rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(126,23,6,0.16))] p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_20px_44px_rgba(101,19,5,0.16)]">
          <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-[1.55rem] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.08),rgba(255,255,255,0.01)_60%)] p-3 sm:p-4">
