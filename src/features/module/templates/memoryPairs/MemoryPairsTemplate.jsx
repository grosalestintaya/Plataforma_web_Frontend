// Template: renderiza el tablero de memoria sobre un layout fijo.
import HeroGrid from "@/features/module/templates/_core/HeroGrid";
import HeroArea from "@/features/module/templates/_core/HeroArea";
...
export default function MemoryPairsTemplate({ variant = "board", data, heroApi, view }) {
  ...
  const layout = normalizeLayout(MEMORY_PAIRS_CONFIG.layout);
