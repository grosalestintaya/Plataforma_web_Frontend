...

      {
        ...
        child: {
          ...
          props: (payload) => ({
            ...
            className: payload?.collageCardData?.className,
            gridClassName: payload?.collageCardData?.gridClassName,
            slotClassName: payload?.collageCardData?.slotClassName,
            emptySlotClassName: payload?.collageCardData?.emptySlotClassName,
          }),
        },
      },
    ],
