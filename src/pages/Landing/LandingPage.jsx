    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 md:py-10">
        ...
        <section id="que-haras-aqui" className="mt-10">
          <h2 className="text-xl font-extrabold tracking-tight">¿Qué harás aquí?</h2>
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-700">
            Quipu Yachay te guía paso a paso: aprendes el concepto, lo practicas y luego tomas
            decisiones más inteligentes en situaciones reales.
          </p>
...
<section className="mt-10"id="recompensas" >
  <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
    <div>
      <h2 className="text-xl font-extrabold tracking-tight">Recompensas y progreso</h2>
      <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-700">
        Cada misión te da puntos. Con puntos subes de nivel, desbloqueas insignias y mejoras tu progreso.
      </p>
    </div>
  ...
  <div className="mt-5 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
    <div className="flex flex-wrap items-center justify-between gap-3">
      <div className="text-sm font-extrabold text-slate-900">Ejemplos de insignias</div>
      <div className="text-xs font-semibold text-slate-600">Se desbloquean por desempeño</div>
    </div>

    <div className="mt-4 flex flex-wrap gap-3">
      <BadgePill label="Ahorrista" bg="bg-[#00C853]/10" text="text-[#00C853]" />
      <BadgePill label="Planificador" bg="bg-[#2962FF]/10" text="text-[#2962FF]" />
      <BadgePill label="Decisor" bg="bg-[#FFC400]/30" text="text-slate-900" />
      <BadgePill label="Constante" bg="bg-[#FF4081]/10" text="text-[#FF4081]" />
      <BadgePill label="Avanzado" bg="bg-[#7C4DFF]/10" text="text-[#7C4DFF]" />
      <BadgePill label="Finalista" bg="bg-[#FF890A]/15" text="text-[#FF890A]" />
    </div>
  </div>
</section>
        ...
        <section id="como-funciona" className="mt-10">
          <h2 className="text-xl font-extrabold tracking-tight">¿Cómo funciona una misión?</h2>

          <div className="mt-5 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <div className="grid gap-4 md:grid-cols-4">
              <Step n="1" title="Historia" desc="Te presentan un caso corto." color="bg-[#FFC400]" />
              <Step n="2" title="Actividad" desc="Respondes, eliges o completas." color="bg-[#2962FF]" />
              <Step n="3" title="Feedback" desc="Te explican el porqué." color="bg-[#00C853]" />
              <Step n="4" title="Recompensa" desc="Ganas puntos e insignias." color="bg-[#7C4DFF]" />
            </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-700">
                Plataforma gamificada de educación financiera para estudiantes. Aprendes con misiones,
                practicas con retos y avanzas con recompensas.
              </p>
            ...
            <div className="md:pl-6">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                <li>
                  <Link className="font-semibold text-slate-700 hover:text-slate-900" to="/login">
                    Iniciar sesión
                  </Link>
                </li>
                <li>
                  <Link className="font-semibold text-slate-700 hover:text-slate-900" to="/i">
                    Introducción
                  </Link>
                </li>
                <li>
                  <a className="font-semibold text-slate-700 hover:text-slate-900" href="#como-funciona">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                <li>
                  <span className="text-slate-700">Preguntas frecuentes (próximamente)</span>
                </li>
                <li>
            ...
            <div className="md:pl-6">
              ...
              <div className="mt-3 rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
                <div className="text-sm font-semibold text-slate-800">Consejo rápido</div>
                <p className="mt-2 text-sm leading-relaxed text-slate-700">
                  No necesitas “ser bueno en mate” para aprender finanzas. Solo constancia: misiones
                  cortas, todos los días.
                </p>
              </div>

              <div className="mt-4 text-xs text-slate-600">
                Al usar la plataforma, se aplican las normas de tu institución educativa y las
                políticas internas del sistema.
              </div>
            </div>
          </div>

          <div className="mt-8 flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-5">
            <div className="text-xs text-slate-600">© {new Date().getFullYear()} Quipu Yachay</div>
...
function BigCard({ title, desc, accent, dot, items }) {
  return (
    <div className={`rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 bg-gradient-to-br ${accent}`}>
      <div className="flex items-center gap-2">
...
function Step({ n, title, desc, color }) {
  return (
    <div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
      <div className="flex items-center gap-3">
        <div className={`grid h-9 w-9 place-items-center rounded-2xl text-sm font-extrabold text-white ${color}`}>
          {n}
        </div>
        <div>
  ...
  return (
    <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className={`grid h-10 w-10 place-items-center rounded-2xl ${color} ${darkText ? "text-slate-900" : "text-white"} font-extrabold`}>
          ★
        </div>
      </div>
...
function BadgePill({ label, bg, text }) {
  return (
    <span className={`rounded-full px-4 py-2 text-xs font-extrabold ring-1 ring-slate-200 ${bg} ${text}`}>
      {label}
    </span>
  );
}
  ...
  return (
    <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
      <div className="flex items-start gap-4">
        <div className={`grid h-10 w-10 place-items-center rounded-2xl ${color} ${darkText ? "text-slate-900" : "text-white"} text-sm font-extrabold`}>
          {n}
        </div>
        <div>
          <div className="text-base font-extrabold text-slate-900">{title}</div>
