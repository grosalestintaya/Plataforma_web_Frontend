          ...
          <div className="flex-1">
            <Field label="Buscar" hint="Busca por nombre, usuario o rol.">
              <input
                ...
                className={inputBase}
                style={inputStyle}
                onFocus={(e) => (e.currentTarget.style.boxShadow = boxShadowFocus)}
              ...
              <table className="w-full border-collapse">
                ...
                >
                  <tr>
                    ...
                    <th className="p-4 text-center text-sm font-semibold">Acciones</th>
                  </tr>
                </thead>
                ...
                <tbody>
                  {filtered.map((u) => (
                    <tr
                      ...
                      onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "rgba(2,6,23,0.03)")}
                    ...
                    >
                      ...
                      <td className="p-4">
                        <span className="text-sm" style={{ color: "var(--card-muted)" }}>
                          @{u.username}
                        </span>
                      </td>
        ...
        <div className="fixed inset-0 bg-black/30 flex justify-center items-start pt-8 z-50">
          ...
          >
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                <h2 className="text-xl font-bold truncate" style={{ color: "var(--card-text)" }}>
            ...
            {(modalMsg || modalErr) && (
              <div
                className="mt-4 rounded-2xl border p-3 text-sm"
                style={{
                  borderColor: modalErr ? "rgba(255,64,129,0.35)" : "rgba(0,200,83,0.30)",
                  backgroundColor: modalErr ? "rgba(255,64,129,0.10)" : "rgba(0,200,83,0.10)",
                  color: "var(--card-text)",
                }}
              >
                <span className="font-semibold">{modalErr ? "Error:" : "Listo:"}</span>{" "}
                <span style={{ color: "var(--card-muted)" }}>{modalErr || modalMsg}</span>
              </div>
            )}
            ...
            <form onSubmit={handleSave} className="mt-6 grid grid-cols-3 gap-6">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="text-center">
                  <p className="text-sm font-semibold" style={{ color: "var(--card-muted)" }}>
                    Imagen de perfil
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <img
                    ...
                    style={{ borderColor: "var(--sidebar)", backgroundColor: "var(--chip-bg)" }}
                  />
                </div>

                <div className="w-full">
                  <Field label="Código de avatar" hint="Ej: default, img-1, img-2...">
                    <input
                      type="text"
                      value={pinnedImg}
                ...
                <div className="w-full">
                  <Field label="Estado">
                    <div
                      ...
                      style={{ borderColor: "var(--card-border)", backgroundColor: "var(--chip-bg)" }}
                    >
                      <StatusPill active={isActive} />
                      <label className="flex items-center gap-2 text-sm font-semibold" style={{ color: "var(--card-text)" }}>
                        <input
                          type="checkbox"
                          checked={isActive}
...
function StatPill({ label, value, tone = "neutral" }) {
  const palette =
    tone === "success"
      ? { bg: "rgba(0,200,83,0.12)", border: "rgba(0,200,83,0.25)", text: "#0A7136" }
      : tone === "danger"
      ? { bg: "rgba(255,64,129,0.12)", border: "rgba(255,64,129,0.25)", text: "#C2185B" }
      : { bg: "rgba(41,98,255,0.10)", border: "rgba(41,98,255,0.20)", text: "var(--sidebar)" };
...
function StatusPill({ active }) {
  return (
    <span
      ...
      style={{
        backgroundColor: active ? "rgba(0,200,83,0.10)" : "rgba(255,64,129,0.10)",
