    ...
    <div className="p-6">
      ...
      >
        ...
        <p className="text-xs mt-1" style={{ color: "var(--card-muted)" }}>
          Administra las entidades base del sistema (colegios, grados, insignias y roles).
        </p>
      </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h2 className="text-base font-bold truncate" style={{ color: "var(--card-text)" }}>
                    {m.title}
                  </h2>
                  <p className="text-sm mt-1 line-clamp-2" style={{ color: "var(--card-muted)" }}>
                    {m.desc}
                  </p>
                </div>
              </div>
