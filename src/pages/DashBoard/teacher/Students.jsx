  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 className="text-xl font-extrabold tracking-tight text-slate-900">Estudiantes</h1>
          <p className="mt-1 text-sm text-slate-600">
            Listado por grados. Usa la búsqueda para encontrar por nombre o usuario.
          </p>
        </div>

        <div className="rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-slate-700 ring-1 ring-slate-200">
          Total: <span className="font-extrabold text-slate-900">{data.pagination.total ?? 0}</span>
        </div>
      </div>
      ...
      <div className="rounded-3xl bg-white p-4 ring-1 ring-slate-200">
        ...
        {!loading && !error && data.items.length === 0 && (
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 text-sm text-slate-700">
            ...
            <div className="mt-1">Prueba con otro nombre/usuario o limpia el filtro.</div>
          </div>
        )}
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-xs font-semibold text-slate-600">{count} estudiante(s)</div>
          </div>
        </div>
