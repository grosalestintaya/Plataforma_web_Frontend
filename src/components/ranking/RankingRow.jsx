...
import XpQuipuIcon from "../icons/XpQuipuIcon";

export default function RankingRow({ participant }) {
  return (
    <div className="group flex items-center gap-4 rounded-full border border-border bg-secondary/50 py-3 pl-4 pr-6 transition-all hover:border-primary/50 hover:bg-secondary hover:shadow-md">
      ...
      <div className="min-w-0 flex-1">
        <div className="truncate font-semibold text-foreground">{participant.full_name}</div>
        <div className="mt-1 text-xs font-semibold text-muted-foreground">{participant.grade}</div>
      </div>
